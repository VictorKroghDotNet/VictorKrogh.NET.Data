...
namespace Dapper.Contrib.Extensions
{
    ...
    public static class SqlMapperExtensions
    {
        ...
        {
            return AsyncHelper.RunSync(() => connection.GetAsync<T>(keys, transaction, commandTimeout));
        }

        public static async Task<T> GetAsync<T>(this IDbConnection connection, object[] keys, IDbTransaction transaction = null, int? commandTimeout = null)
            where T : class
        {
            var type = typeof(T);
        ...
        {
            return AsyncHelper.RunSync(() => connection.GetAllAsync<T>(transaction, commandTimeout));
        }
...
#pragma warning restore CA2211 // Non-constant fields should not be visible
        ...
        {
            return AsyncHelper.RunSync(() => connection.InsertAsync(entityToInsert, transaction, commandTimeout));
        }
        ...
        {
            return AsyncHelper.RunSync(() => connection.UpdateAsync(entityToUpdate, transaction, commandTimeout));
        }
        ...
        {
            return AsyncHelper.RunSync(() => connection.DeleteAsync(entityToDelete, transaction, commandTimeout));
        }
        ...
        {
            return AsyncHelper.RunSync(() => connection.DeleteAllAsync<T>(transaction, commandTimeout));
        }
